...
def jadwalshalat():
	if request.args.get('daerah'):
		try:
			...
			#url = 'https://api.haipbis.xyz/jadwalsholat?daerah={}'.format(daer)
			jadwal = get('https://api.haipbis.xyz/jadwalsholat?daerah={}'.format(daer)).json()
			return {
